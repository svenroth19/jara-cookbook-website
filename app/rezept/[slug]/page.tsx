    ...
    <div>
      ...
      <div className="mx-auto max-w-[760px] px-4 py-12">
        ...
        <div className="mb-5 text-center">
          <span
            className="inline-block rounded px-3 py-1 text-[0.68rem] font-bold uppercase"
            style={{
              background: '#f2ebe1',
              color: '#8a7060',
        ...
        {/* Title */}
        <h1
          className="font-display text-center font-bold italic leading-[1.15] tracking-[0.01em] text-[#6b1f2b]"
        ...
        {sections.map((section, index) => (
          <div key={index}>
            {section.type === 'ingredients' && (
              <div>
                <h2
                  className="font-display mb-6 text-[1.75rem] font-medium tracking-[0.01em]"
                  style={{ color: '#1c1410' }}
                >
                  Zutaten
                </h2>
